        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              ...
              Learn about spodumene's properties, applications, and critical
              role in sustainable technology.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Spodumene is a pyroxene mineral consisting of lithium aluminum
                inosilicate (LiAl(SiO₃)₂). It is the most commercially
                significant lithium ore mineral and the primary source of
                lithium for battery manufacturing worldwide.
              </p>
              <p className="text-lg text-muted-foreground mb-6 leading-relaxed">
                Found in lithium-rich pegmatites, spodumene typically occurs as
                prismatic crystals that can range from colorless to various
                shades of white, gray, pink, or green. The mineral's high
                lithium content makes it invaluable for the growing electric
              ...
              <div className="bg-secondary/50 p-4 rounded-lg">
                ...
                <p className="text-muted-foreground">
                  LiAl(SiO₃)₂ - Lithium Aluminum Silicate
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
              Spodumene's unique properties make it essential for numerous
              applications in modern technology and sustainable energy
              solutions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="group hover:shadow-professional transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Primary source of lithium for electric vehicle batteries,
            ...
            <Card className="group hover:shadow-professional transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Critical component in EV battery production, enabling the
            ...
            <Card className="group hover:shadow-professional transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Used in specialty glass and ceramic applications requiring low
            ...
            <Card className="group hover:shadow-professional transition-all duration-300">
              <CardContent className="p-6 text-center">
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Enabling clean energy technologies that reduce carbon
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Spodumene is typically extracted through open-pit mining
                  operations. The ore is then crushed and processed through
                  flotation methods to concentrate the spodumene mineral.
                  Advanced processing techniques have made extraction more
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  After extraction, spodumene concentrate undergoes a conversion
                  process to produce lithium hydroxide or lithium carbonate.
                  These compounds are the key materials used in battery
                  manufacturing. The conversion involves heating the concentrate
                  to high temperatures (decrepitation) followed by acid leaching
                  and purification.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Major spodumene mining operations are located in Australia,
                  which accounts for over 50% of global production. Other
                  significant producers include China, Zimbabwe, and Brazil. The
                  growing demand for lithium has led to the development of new
                  mining projects worldwide, with particular focus on
              ...
              <div className="rounded-lg overflow-hidden shadow-lg">
                ...
                <div className="p-4 bg-card">
                  <h3 className="font-semibold text-foreground">
                    Spodumene Crystal Structure
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Natural crystalline formation
                  </p>
                </div>
              </div>
